          ...
          <div className="mt-16">
            <div className="flex justify-between items-center mb-8">
              <div>
                ...
                <h3 className="text-2xl font-bold text-gray-900">Client <span className="text-orange-500">Reviews</span></h3>
              </div>
              <a href="#" className="group inline-flex items-center gap-1 text-orange-500 text-sm font-semibold hover:text-orange-600 transition-colors cursor-pointer">
                View All
