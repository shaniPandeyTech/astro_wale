    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className=" w-full md:w-[520px] text-left  text-3xl md:text-[32px] font-bold text-gray-900 mb-4">
              Our Astrology Services - Unlock The Secrets of Your Life!
            </h2>
          </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-600 mb-6">
                  With over 25 years of experience in Vedic astrology, we have
                  guided thousands of people towards a better understanding of
                  their life's purpose and destiny. Our team of certified
                  astrologers combines ancient wisdom with modern insights to
                  provide accurate predictions and practical solutions.
                </p>
                <p className="text-gray-600 mb-6">
                  We specialize in various branches of astrology including Vedic
                  astrology, numerology, palmistry, and vastu shastra. Our
                  personalized approach ensures that each consultation is
                  tailored to your unique birth chart and life circumstances.
                </p>
                <button className="text-orange-500 flex gap-x-2  hover:shadow-orange-50 cursor-pointer transform transition-transform hover:scale-105 duration-300">
                  Join the Horoscope Vale family today and discover what the
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 lg:grid-cols-5 gap-6">
              {Array(8)
                ...
                .map((_, index) => (
                  <div
                    key={index}
                    className="bg-white rounded-xl border shadow-sm p-4 hover:shadow-md  relative cursor-pointer transform transition-transform hover:scale-105 duration-300  "
                  >
                    {index % 4 === 0 && (
      ...
      >
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10 items-center relative z-10">
              ...
              <div>
                <div className="flex items-start  gap-3">
                  ...
                  <p className="text-white/80 mt-1">
                    Trusted, experienced, and highly rated.
                  </p>
                </div>
              </div>
          ...
          <div className="flex justify-center">
            <Image
              src="/images/candid-image-photography.svg"
              alt="Astrologer"
              width={538}
              height={888}
              className="w-[538px] md:w-[538px] rounded-xl object-cover"
            />
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div className="text-white space-y-6">
              ...
              <p className="text-orange-100 text-lg">
                Don't let uncertainty hold you back. Get personalized
                astrological guidance from our expert astrologers and unlock the
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              {
                rating: 5,
                text: "Absolutely amazing predictions! Everything came true exactly as predicted.",
                author: "Priya Sharma",
              },
              {
                rating: 5,
                text: "Best astrology service I've ever used. Highly recommended!",
                author: "Raj Kumar",
              },
              {
                rating: 4,
                text: "Very accurate readings and professional service. Thank you!",
                author: "Sunita Devi",
              },
              {
                rating: 5,
                text: "Life-changing guidance. My problems were solved completely.",
                author: "Amit Patel",
              },
            ].map((review, index) => (
            ...
            {[
              {
                ...
                a: "Our predictions are based on authentic Vedic astrology principles with over 85% accuracy rate.",
              },
              {
                q: "What information do I need for consultation?",
                a: "You need your exact date, time, and place of birth for accurate readings.",
              },
              {
                q: "Are consultations confidential?",
                a: "Yes, all consultations are 100% private and confidential.",
              },
              {
                q: "How quickly will I get my reading?",
                a: "You can get instant consultations 24/7 through chat or schedule a call.",
              },
            ].map((faq, index) => (
              <div>saroj</div>
            ))}
      ...
      <footer className="bg-orange-500 text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-orange-100 mb-4">
                Get Astrology Guidance on Mobile, Anywhere, Anytime!
              </p>
          ...
          <div className="border-t border-orange-400 pt-8 text-center text-orange-100">
            <p>
              &copy; 2024 Horoscope Vata. All rights reserved. | Privacy Policy
              | Terms of Service
            </p>
          </div>
        </div>
